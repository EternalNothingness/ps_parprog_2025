...
\begin{document}
	...
	\begin{tikzpicture}
		\begin{axis}[
        		...
        		\addplot table [x index=0,y index=1, col sep=comma] {ex3/mandelbrot_scheduling.dat};
        		\addplot table [x index=0,y index=1, col sep=comma] {ex3/hadamard_scheduling.dat};
